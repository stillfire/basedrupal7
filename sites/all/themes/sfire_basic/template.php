...
function sfire_starter_preprocess_page(&$variables, $hook) {
...
function sfire_starter_block_list($region) {
...
function sfire_starter_preprocess_block(&$vars) {

  // Adds 'first' and 'last' class to blocks for styling.

  $block_count = count(sfire_starter_block_list($vars['block']->region));
